...
WANDB_NAME="hnet_twostage_seqlen-${SEQLEN_DIS}_d_model-${D_MODEL}_n_enc_layer-${ENC_LAYER}_n_main_layer-${MAIN_LAYER}_n_dec_layer-${DEC_LAYER}_lr-${LR}_tokenizer_type-${TOKENIZER_TYPE}"
