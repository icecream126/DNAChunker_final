...
class HNetTransformer(CaduceusPreTrainedModel):
...
class HNetTransformerForMaskedLM(CaduceusPreTrainedModel):
...
class HNetTransformerForSequenceClassification(CaduceusPreTrainedModel):
    def __init__(
            self,
            config: HNetConfig,
